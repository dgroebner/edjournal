...
/**
 * Modellklasse für den Elite Dangerous Journaleintrag 'Touchdown'
 * 
 * @author dgroebner
 */
public class Touchdown extends GenericModel<Touchdown.Fields> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Touchdown.class);

    /**
     * Felder des Elite Dangerous Journaleintrag 'Touchdown'
     * 
     * @author dgroebner
     */
     ...
     */
    public Touchdown(final JSONObject json) {
