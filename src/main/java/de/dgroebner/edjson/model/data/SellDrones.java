...
/**
 * Modellklasse für den Elite Dangerous Journaleintrag 'SellDrones'
 * 
 * @author dgroebner
 */
public class SellDrones extends GenericModel<SellDrones.Fields> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SellDrones.class);

    /**
     * Felder des Elite Dangerous Journaleintrag 'SellDrones'
     * 
     * @author dgroebner
     */
     ...
     */
    public SellDrones(final JSONObject json) {
