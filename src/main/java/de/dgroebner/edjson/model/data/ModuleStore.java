...
/**
 * Modellklasse für den Elite Dangerous Journaleintrag 'ModuleStore'
 * 
 * @author dgroebner
 */
public class ModuleStore extends GenericModel<ModuleStore.Fields> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModuleStore.class);

    /**
     * Felder des Elite Dangerous Journaleintrag 'ModuleStore'
     * 
     * @author dgroebner
     */
     ...
     */
    public ModuleStore(final JSONObject json) {
