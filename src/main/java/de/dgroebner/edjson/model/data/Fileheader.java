...
/**
 * Modellklasse für den Elite Dangerous Journaleintrag 'Fileheader'
 * 
 * @author dgroebner
 */
public class Fileheader extends GenericModel<Fileheader.Fields> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Fileheader.class);

    /**
     * Felder des Elite Dangerous Journaleintrag 'Fileheader'
     * 
     * @author dgroebner
     */
    public enum Fields implements JournalModelField {
        ...
        PART("part", Integer.class),
        LANGUAGE("language", String.class),
        GAMEVERSION("gameversion", String.class),
        BUILD("build", String.class);
        /* @formatter:on */
     ...
     */
    public Fileheader(final JSONObject json) {
