...
/**
 * Modellklasse für den Elite Dangerous Journaleintrag 'Progress'
 * 
 * @author dgroebner
 */
public class Progress extends GenericModel<Progress.Fields> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Progress.class);

    /**
     * Felder des Elite Dangerous Journaleintrag 'Progress'
     * 
     * @author dgroebner
     */
     ...
     */
    public Progress(final JSONObject json) {
